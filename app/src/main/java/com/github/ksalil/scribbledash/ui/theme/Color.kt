...
val OnTertiaryContainer = Color(0xFF3E2700) // Example dark color, might need refinement
...
val Surface = Color(0xFFFFFFFF).copy(alpha = 0.8f)
...
val OnSurfaceVariant = Color(0xFF7F7163)
val SurfaceVariant = Color(0xFFF6F1EC)
val Outline = Color(0xFF7F7163)
val SurfaceTint = Primary
val Success = Color(0xFF0DD280)
val OnSuccess = Color(0xFFFFFFFF)
val GameModeItemBorderColor = Color(0xFF12B974)
val BottomNavBarItemUnselectedColor = Color(0xFF726558)
val BackgroundGradientEnd = Color(0xFFFFF1E2)
val ShadowColor = Color(0xFF726558)